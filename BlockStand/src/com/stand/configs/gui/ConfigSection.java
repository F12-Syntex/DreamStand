...
import com.stand.utils.Communication;
import com.stand.utils.ComponentBuilder;
import com.stand.utils.Input;
...
public class ConfigSection extends ConfigGUI {
	...
	public List<PagedItem> Contents() {
		...
		this.configSection.getKeys(false).forEach(i -> {
			...
			ItemStack section = new ItemStack(Material.valueOf(Stand.getInstance().configManager.configs.Sections));
			ItemStack ints = new ItemStack(Material.valueOf(Stand.getInstance().configManager.configs.Numbers));
			ItemStack text = new ItemStack(Material.valueOf(Stand.getInstance().configManager.configs.Text));
			ItemStack booleanON = new ItemStack(Material.valueOf(Stand.getInstance().configManager.configs.BooleanON));
			ItemStack booleanOFF = new ItemStack(Material.valueOf(Stand.getInstance().configManager.configs.BooleanOFF));
			ItemStack lists = new ItemStack(Material.valueOf(Stand.getInstance().configManager.configs.Lists));
					...
					execution = () -> {
						...
						Communication.applyInput(player, new Input() {
							...
							public void onRecieve(String o) {
								...
								Bukkit.getScheduler().callSyncMethod(Stand.getInstance(), new Callable<Object>() {
									@Override
