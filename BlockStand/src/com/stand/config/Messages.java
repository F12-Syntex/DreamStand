...
public class Messages extends Config{
	...
	public String prefix = "&c[&6Stand&c]";
	...
	public Messages(String name, double version) {
		...
		this.updateMessages("invalid_start", "%prefix% &cCan't start the minigame!");
		this.updateMessages("invalid_stop", "%prefix% &cCan't stop the minigame!");
		this.updateMessages("game_started", "%prefix% &aStarted!");
		this.updateMessages("game_stopped", "%prefix% &cGame canceled.");
		this.updateMessages("block_find_message", "%prefix% &aYou have 5 minutes to stand on a &7%block%!");
		this.updateMessages("block_ended_message", "%prefix% &cThe game has been closed!");
		
		this.updateMessages("block_found", "%prefix% &6&l%player% has found his block!");
		this.updateMessages("block_not_found", "%prefix% &cYou're out of this round!");
		this.updateMessages("next_round", "%prefix% &c%winner% has won this round.");
		
		this.updateMessages("game_end", "%prefix% &c%winner% has won the game!");
		
		this.updateMessages("player_lost", "%prefix% &cYour out!");
