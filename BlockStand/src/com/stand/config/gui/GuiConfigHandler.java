...
import com.stand.GUI.GenericConfigurableInterface;
import com.stand.GUI.PagedConfigurableGUI;
import com.stand.GUI.PagedGeneratedGUI;
import com.stand.GUI.TestGeneratedGui;
import com.stand.config.ConfigItem;
import com.stand.config.Configuration;
			...
			interfaces.add(new GUIConfig(i, 1.2) {
				...
				public void initialize() {
					...
					for(String index : section.getKeys(false)) {
						...
						if(i instanceof com.stand.GUI.PagedConfigurableGUI) {
				...
				public void defaults() {
					...
					for(GuiItem o : i.configuration()) {
						...
						*/
						...
						if(i instanceof com.stand.GUI.PagedGeneratedGUI) {
