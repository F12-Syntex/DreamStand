...
public class Permissions extends Config{
	...
	public String admin = "stand.admin";
	public String bypass = "stand.timer.bypass";
	public String reload = "stand.admin.reload";
	public String configure = "stand.admin.configure";
	public String defaultShop = "stand.admin.default.shop";
